...
//   imagen    → ruta a una imagen en img/ (póster/promoción) o null;
//               se muestra en grande dentro del aviso
...
//   enlace    → página interna del sitio (ej. "inscripciones.html") o una
//               salida aprobada por la Dirección (app de asistencia, app de
//               inscripción, FB/IG), o null. PROHIBIDO: PDFs y cualquier
//               otro sitio externo — el contenido se transcribe en "cuerpo"
//   enlaceTexto → texto del botón del enlace (ej. "Ver requisitos")
//
...
window.AVISOS = [
  {
    ...
    imagen: "img/aviso-inscripciones.webp",
    imagenAlt: "Cartel oficial: Ven y forma parte del CEB 9/22 — inscripciones abiertas del ciclo 2026-2027 a partir del 17 de agosto, de 14:00 a 20:00 h",
